...
class GustavsonsSpGEMMSDMemory : public MemoryController {
 private:
  ...
  std::size_t n_str_req_recv;
  std::size_t n_str_req_sent;

  //Current pointers
  std::size_t current_MK;
  std::size_t current_MK_row_pointer;
  std::size_t current_MK_col_id;
 ...
 public:
  ...
  virtual void setDenseSpatialData(std::size_t T_N, std::size_t T_K) {}

  virtual void setSparseMatrixMetadata(metadata_address_t MK_metadata_id, metadata_address_t MK_metadata_pointer) {}
};
