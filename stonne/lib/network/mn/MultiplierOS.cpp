...
MultiplierOS::MultiplierOS(stonne_id_t id, std::string name, int row_num, int col_num, Config stonne_cfg, Connection* left_connection,
                           Connection* right_connection, Connection* top_connection, Connection* bottom_connection)
    : MultiplierOS(id, name, row_num, col_num, stonne_cfg) {
...
void MultiplierOS::setVirtualNeuron(std::size_t VN) {
  this->VN = VN;
  this->mswitchStats.n_configurations++;
#ifdef DEBUG_MSWITCH_CONFIG
  std::cout << "[MSWITCH_CONFIG] MultiplierOS "
...
#ifdef DEBUG_MSWITCH_FUNC
      std::cout << "[MSWITCH_FUNC] Cycle " << this->local_cycle << ", MultiplierOS " << this->num << " has received an IACTIVATION from the left connection"
                << std::endl;
#endif
...
#ifdef DEBUG_MSWITCH_FUNC
      std::cout << "[MSWITCH_FUNC] Cycle " << this->local_cycle << ", MultiplierOS " << this->num << " has received a weight from the top connection"
                << std::endl;
#endif
...
void MultiplierOS::printConfiguration(std::ofstream& out, std::size_t indent) {
...
void MultiplierOS::printStats(std::ofstream& out, std::size_t indent) {
...
void MultiplierOS::printEnergy(std::ofstream& out, std::size_t indent) {
  /*
