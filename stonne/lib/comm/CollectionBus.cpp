...
Connection* Bus::getInputConnectionFromBusLine(std::size_t busID, std::size_t inputID) {
...
void Bus::printStats(std::ofstream& out, std::size_t indent) {
...
void Bus::printEnergy(std::ofstream& out, std::size_t indent) {
  /*
