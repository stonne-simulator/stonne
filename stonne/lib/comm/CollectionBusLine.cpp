...
Connection* CollectionBusLine::getInputPort(std::size_t inputID) {
...
void CollectionBusLine::printStats(std::ofstream& out, std::size_t indent) {
...
void CollectionBusLine::printEnergy(std::ofstream& out, std::size_t indent) {
  /*
