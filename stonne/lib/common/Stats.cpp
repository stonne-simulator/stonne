...
void ConnectionStats::print(std::ofstream& out, std::size_t indent) {}
...
void FifoStats::print(std::ofstream& out, std::size_t indent) {
...
void DSwitchStats::print(std::ofstream& out, std::size_t indent) {
...
void MSwitchStats::print(std::ofstream& out, std::size_t indent) {
...
void MultiplierOSStats::print(std::ofstream& out, std::size_t indent) {
...
void ASwitchStats::print(std::ofstream& out, std::size_t indent) {
...
void AccumulatorStats::print(std::ofstream& out, std::size_t indent) {
  out << ind(indent) << "\"Total_cycles\" : " << this->total_cycles << "," << std::endl;
...
void SDMemoryStats::print(std::ofstream& out, std::size_t indent) {
  out << ind(indent) << "\"Total_cycles\" : " << this->total_cycles << "," << std::endl;
  ...
  out << ind(indent) << "\"Dataflow\" : "
      << "\"" << get_string_dataflow_type(this->dataflow) << "\""
      << "," << std::endl;
...
void CollectionBusLineStats::print(std::ofstream& out, std::size_t indent) {
