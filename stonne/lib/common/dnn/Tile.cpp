...
Tile::Tile(std::size_t T_R, std::size_t T_S, std::size_t T_C, std::size_t T_K, std::size_t T_G, std::size_t T_N, std::size_t T_X_, std::size_t T_Y_,
           bool folding) {
  this->T_R = T_R;
  this->T_S = T_S;
  this->T_C = T_C;
...
void Tile::printConfiguration(std::ofstream& out, std::size_t indent) {
