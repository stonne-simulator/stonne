...
class CompilerFEN : public CompilerComponent {
 private:
  ...
  //Aux functions
  void generate_fen_signals(std::size_t num_ms);         //Generate the signals for the Adder swithces
  void generate_fen_enabling_links(std::size_t num_ms);  //Generate the signals for the Adder switches
