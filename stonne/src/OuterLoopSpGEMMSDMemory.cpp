...
OuterLoopSpGEMMSDMemory::OuterLoopSpGEMMSDMemory(id_t id, std::string name, Config stonne_cfg, Connection* write_connection, Memory<float>& mem) : MemoryController(id, name), mem(mem) {
