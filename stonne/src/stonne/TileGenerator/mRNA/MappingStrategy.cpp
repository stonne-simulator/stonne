...
#include "TileGenerator/mRNA/MappingStrategy.hpp"
...
double MappingStrategy::gettotal_energy() {
  const double totaleng = spminputread_eng[config_num] + spmweightread_eng[config_num] + spmwrite_eng[config_num] + msreg_eng[config_num] +
                          msaccess_eng[config_num] + multiply_eng[config_num] + reduce_eng[config_num] + rsaccess_eng[config_num] + dsaccess_eng[config_num] +
                          dram_eng;
  return totaleng;
}
