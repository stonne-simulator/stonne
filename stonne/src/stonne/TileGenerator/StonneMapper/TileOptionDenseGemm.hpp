...
#include "TileGenerator/Utils/Tiles.hpp"
...
class TileOptionDenseGemm {
 ...
 public:
  ...
  TileOptionDenseGemm(std::size_t num_ms, std::size_t M, std::size_t N, std::size_t K, std::size_t T_M, std::size_t T_N, std::size_t T_K);
